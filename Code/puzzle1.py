...
## printing pairs and multiplying to obtain final results

# part 1 

print(findPairsAdd(lst, K))
result_add = (findPairsAdd(lst, K))
product_add = (lambda a, b: a*b)(*result_add[0])
print(product_add)

# part 2

print(findPairsMult(lst, K))
result_mult = (findPairsMult(lst, K))
product_mult = (lambda a, b, c: a*b*c)(*result_mult[0])
print(product_mult)
